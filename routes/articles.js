...
router.post('/articles/:id/comments', passport.authenticate('jwt', { session: false }), injectionUser, articlesController.addComment);
...
router.delete('/articles/:id/comments/:commentId', passport.authenticate('jwt', { session: false }), injectionUser, articlesController.deleteComment);
